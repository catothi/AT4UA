...
/**
 * Demo 1 - Normaler Flow (at-most-once, ohne Verlust).
 *
 * Schickt 5 Rechen-Aufgaben (a + b) an die Queue "calc.tasks.normal"
 * und wartet auf die Ergebnisse aus "calc.results.normal".
 *
 * Jede Nachricht bekommt eine sequenziell steigende msgId (1..5).
 * Der Producer schreibt jede Aufgabe genau EIN MAL.
 */
public class CalcProducer {

    public static final String TASK_QUEUE   = "calc.tasks.normal";
    public static final String RESULT_QUEUE = "calc.results.normal";
